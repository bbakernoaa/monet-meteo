...
class AtmosphericProfile:
    ...
    def calculate_thermodynamic_properties(self):
        ...
        """
        from .thermodynamics.thermodynamic_calculations import equivalent_potential_temperature, potential_temperature, virtual_temperature

        # Calculate potential temperature if not provided
        if self.potential_temperature is None:
            self.potential_temperature = potential_temperature(self.pressure, self.temperature)
        ...
        if self.virtual_temperature is None and self.mixing_ratio is not None:
            self.virtual_temperature = virtual_temperature(self.temperature, self.mixing_ratio)
        ...
        if self.equivalent_potential_temperature is None and self.mixing_ratio is not None:
            self.equivalent_potential_temperature = equivalent_potential_temperature(self.pressure, self.temperature, self.mixing_ratio)
